...
// Verificar se os clientes estão logados e se é um administrador
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['adicionar'])) {
        ...
        $stmt = $pdo->prepare('INSERT INTO clientes (nome, email, senha, perfil) VALUES (?, ?, ?, ?)');
    ...
    if (isset($_POST['excluir'])) {
        ...
        $stmt = $pdo->prepare("DELETE FROM clientes WHERE id IN ($ids)");
        $stmt->execute();
    }
